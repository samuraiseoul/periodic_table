...
PageHeader.defineSelf();

TableTitle.defineSelf();
CircleKey.defineSelf();
TriangleKey.defineSelf();
OctagonKey.defineSelf();
TableLegend.defineSelf();
PeriodicTableElement.defineSelf();
ElementModal.defineSelf();
FirstRow.defineSelf();
SecondRow.defineSelf();
ThirdRow.defineSelf();
FourthRow.defineSelf();
FifthRow.defineSelf();
SixthRow.defineSelf();
SeventhRow.defineSelf();
EighthRow.defineSelf();
NinthRow.defineSelf();
TenthRow.defineSelf();
EleventhRow.defineSelf();
PeriodicTable.defineSelf();

AboutUs.defineSelf();
ContactUs.defineSelf();
GetInvolved.defineSelf();
FrequentlyAskedQuestions.defineSelf();

PageFooter.defineSelf();